                ...
                },
                {
                    ...
                    elements: [ {
                        ...
                        onChange: function() {
                            ...
                            let types = 'text/calendar,image/png,image/gif,image/jpg,image/jpeg';
                            ...
                            // 文件类型判断的处理
                            if (!typeList.some(type => type === file.type)) {
                                alert(editor.lang.image.checkFileType);
                                fileDom.value = '';
                                return false;
                            }
                            // 图片文件的处理
                            if (file.type !== 'text/calendar') {
                                if( file.size / 1024 / 1024 > 1 ){
                                    alert(editor.lang.image.picSize);
                                    fileDom.value = '';
                                    return false;
                                }
                                // 文件分辨率判断的处理
                                ...
                                reader.onload = function (e) {
                                    ...
                                    image.onload=function(){
                                        ...
                                        if(image.width > 1080 && image.height > 720){
                                            alert(editor.lang.image.picMSize);
                                            fileDom.value = '';
                                            return false;
                                        }else{

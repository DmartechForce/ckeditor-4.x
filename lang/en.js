...
CKEDITOR.lang["en"] = {
  ...
  image: {
    ...
    picSize: "Picture size cannot be greater than 1 Megabyte!",
    picMSize: "Picture size cannot be greater than 1080x720!",
    button2Img:
    ...
    checkFileType: "Please select the correct file type"
  },
  ...
  table: {
    ...
    cell: {
      ...
      yes: "Yes",
      no: "No",
      invalidWidth: "Please enter an integer.",
      invalidHeight: "Please enter an integer.",
      invalidRowSpan: "Please enter an integer.",
      invalidColSpan: "Please enter an integer.",
      chooseColor: "Choose",
    },
    ...
    invalidCols: "The number of columns and rows is required. Please enter an integer.",
    invalidHeight: "Table height must be a number.",
    invalidRows: "The number of columns and rows is required. Please enter an integer.",
